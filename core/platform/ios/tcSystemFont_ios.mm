// =============================================================================
// iOS system font lookup — same CoreText backend as macOS.
// (CoreText / CTFontDescriptor / CTFontManager are part of iOS too, with the
// same headers and behavior — only the bundled font set differs.)
// =============================================================================
