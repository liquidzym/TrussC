...
- The GPU fluid path currently covers splat, velocity/density/temperature texture injection, advection, optional vorticity, optional buoyancy, obstacle masks, divergence, Jacobi pressure solve, projection, and GPU density/velocity/pressure/temperature/combined display.
...
- LIC/streamlines, velocity-dot/field visualizers, average watchers, split-velocity shader parity, colorize/erode/dilate/inverse-warp/timeblur helper shaders, and PixelFlow multiple-fluid examples are still tracked in `REFERENCE_GAPS.md`.
