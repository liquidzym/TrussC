...
- Full streamline particle rendering, split-velocity shader parity, advanced bridge controls such as invert/alpha/mirror options, and PixelFlow-style particle variants remain pending.
